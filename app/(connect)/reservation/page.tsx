  ...
  return (
    <div className='no-scrollbar flex flex-col h-full'>
      <header className="sticky top-0 z-10 w-full h-[72px] flex items-center justify-center bg-white shadow-lg">
        ...
        <span className="text-[16px] leading-[24px] text-center font-semibold">{t("headerTitle")}</span>
      </header>
      ...
      <div className='overflow-y-scroll flex-1 no-scrollbar mx-2 my-4 space-y-8'>
        <div className='mx-2 space-y-2'>
          <div className='flex items-center justify-between max-w-[800px] md:mx-auto'>
            <span className='text-[15px] font-semibold'>{t("headerTitle")}</span>
            <button className='text-[11px] font-semibold text-[#F45D48] underline underline-offset-1'>{t("cancelShoot")}</button>
          </div>
          <div className='bg-[#F7F7F7] rounded-lg max-w-[800px] md:mx-auto min-h-[52px] p-2 w-full flex flex-wrap items-center gap-[8px] transition-all duration-300'>
            ...
            <div className='flex flex-col items-start gap-1'>
              <span className='text-[#B9B9B9] text-[11px] font-normal'>{t("photographerNameLabel")}</span>
        ...
        <div className='mx-2 space-y-2'>
          <div className='flex items-center justify-between max-w-[800px] md:mx-auto'>
            <span className='text-[15px] font-semibold'>{t("paymentDetailsTitle")}</span>
          </div>
          <div className='bg-[#F7F7F7] rounded-lg max-w-[800px] md:mx-auto min-h-[52px] p-2 w-full flex flex-wrap items-center gap-[8px] transition-all duration-300'>
            <div className='h-[48px] aspect-square flex items-center justify-center'>
              {yenIcon}
            ...
            <div className='flex flex-col items-start gap-1'>
              <span className='text-[#B9B9B9] text-[11px] font-normal'>{t("priceLabel")}</span>
          ...
          <div className='max-w-[800px] md:mx-auto'>
            {reservation?.payment_status === "pending" ?
              <span className='text-[16px] font-medium text-[#111111]'>{t("paymentPending")} <button onClick={handleCheckout} className={`${reservation?.user_id?._id === userIdRef.current ? "hidden" : ""} text-white bg-secondary px-8 py-2 rounded-lg text-[16px] font-semibold`}> {t("payNow")} </button></span> :
              reservation?.payment_status === "failed" ?
                <span className='text-[16px] font-medium text-[#111111]'>{t("paymentFailed")} <button onClick={handleCheckout} className={`${reservation?.user_id?._id === userIdRef.current ? "hidden" : ""} text-white bg-secondary px-8 py-2 rounded-lg text-[16px] font-semibold`}> {t("payNow")} </button></span> :
                reservation?.payment_status === "paid" ?
                  <span className='text-[16px] font-medium text-[#111111]'>{t("paymentPaid")}</span> :
                  <></>
            }
          </div>
        </div>
        ...
        <div className='mx-2 space-y-2'>
          <div className='flex items-center justify-between max-w-[800px] md:mx-auto'>
            <span className='text-[15px] font-semibold'>{t("dateTimeTitle")}</span>
          ...
          <div className='bg-[#F7F7F7] rounded-lg max-w-[800px] md:mx-auto min-h-[52px] py-2 w-full flex flex-wrap items-center justify-around px-4 gap-[8px] transition-all duration-300'>
            <div className='flex items-center flex-wrap gap-2'>
              ...
              <div className='flex flex-col items-start gap-1'>
                <span className='text-[#B9B9B9] text-[10px] font-normal'>{t("dateLabel")}</span>
            ...
            <div className='flex items-center flex-wrap gap-2'>
              ...
              <div className='flex flex-col items-start gap-1'>
                <span className='text-[#B9B9B9] text-[10px] font-normal'>{t("timeLabel")}</span>
        ...
        <div className='mx-2 space-y-2'>
          <div className='flex items-center justify-between max-w-[800px] md:mx-auto'>
            <span className='text-[15px] font-semibold'>{t("specificationsTitle")}</span>
            {/* <button className='text-[11px] font-semibold text-[#F45D48] underline underline-offset-1'>{editIcon}</button> */}
          </div>
          <div className='bg-[#F7F7F7] rounded-lg max-w-[800px] md:mx-auto min-h-[52px] py-2 w-full flex flex-wrap items-center justify-center gap-[8px] transition-all duration-300'>
            <button onClick={() => setSelectedMode(0)} className={`${selectedMode === 0 ? "bg-primary text-white rounded-md" : ""} h-[40px] w-[45%] text-center font-semibold text-[14px] leading-[21px] transition-all duration-300`}>{t("modeNormal")}</button>
            <button onClick={() => setSelectedMode(1)} className={`${selectedMode === 1 ? "bg-primary text-white rounded-md" : ""} h-[40px] w-[45%] text-center font-semibold text-[14px] leading-[21px] transition-all duration-300`}>{t("modeRaining")}</button>
          </div>
        </div>
        ...
        <div className='relative w-full max-w-[800px] md:mx-auto h-auto'>
          ...
          <div className={`w-full space-y-4 mx-2 opacity-0`}>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingPlace")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingLocation")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("meetingPoint")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingConcept")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("clothingType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shoesType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("itemsType")}e</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("makeUpType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>NA</span>
            </div>
          </div>
          ...
          <div className={`absolute top-0 left-0 w-full space-y-4 mx-2 ${selectedMode === 0 ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-full"} transition-all duration-300 ease-out`}>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingPlace")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shootingPlace ?? (t("na"))}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingLocation")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shootingLocation ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("meetingPoint")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.meetingPoint ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingConcept")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shootingConcept ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("clothingType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.clothingType ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shoesType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shoesType ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("itemsType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.itemsType ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("makeUpType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.makeUpType ?? t("na")}</span>
            </div>
          </div>
          ...
          <div className={`absolute top-0 left-0 w-full space-y-4 mx-2 ${selectedMode === 0 ? "opacity-0 translate-x-full" : "opacity-100 translate-x-0"} transition-all duration-300 ease-out`}>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingPlace")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shootingPlaceRainy ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingLocation")}n</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shootingLocationRainy ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("meetingPoint")}t</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.meetingPointRainy ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shootingConcept")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shootingConceptRainy ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("clothingType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.clothingTypeRainy ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("shoesType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.shoesTypeRainy ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("itemsType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.itemsTypeRainy ?? t("na")}</span>
            </div>
            <div className='space-y-2'>
              <span className='block md:inline-block md:w-[400px] text-[#AAAAAA] text-[15px] leading-[27px] font-normal'>{t("makeUpType")}</span>
              <span className='block md:inline-block md:w-[400px] text-[#111111] text-[13px] font-semibold'>{loading ? <div className='h-[20px] w-[180px] bg-gray-300 animate-pulse rounded-md'></div> : reservation?.makeUpTypeRainy ?? t("na")}</span>
            </div>
          </div>
        </div>
      ...
      <div className='flex items-center justify-center gap-6 w-full md:mx-auto py-4 px-2 shadow-[0_4px_20px_rgba(0,0,0,0.15)] '>
        <Drawer open={shootModePopup} onOpenChange={setShootModePopup}>
          <DrawerTrigger className='md:max-w-[800px] w-full h-[54px] text-[16px] leading-[24px] font-bold text-center bg-secondary flex items-center justify-center text-white rounded-md'>{t("useShootMode")}</DrawerTrigger>
          <DrawerContent>
            ...
            <div className='space-y-8 mx-4 md:max-w-[800px] md:w-full md:mx-auto'>
              <div className='text-center space-y-4'>
                <span className='font-medium text-[16px] leading-[21px]'>{t("shootingModePopupTitle")}</span>
                <p className='text-[#313634] text-[13px] font-normal'>{t("shootingModePopupDesc1")}.</p>
                <p className='text-[#313634] text-[13px] font-normal'>{t("shootingModePopupDesc2")}</p>
                <span className='text-[#FF0000] text-[13px] font-medium'>{t("shootingModePopupNote")}</span>
              </div>

              <div className='flex flex-col items-center justify-between flex-wrap'>
                <button className='w-full mx-auto h-[54px] text-[16px] leading-[24px] font-bold text-center bg-secondary flex items-center justify-center text-white rounded-md'>{t("shootingModePopupStartNow")}</button>
                <button onClick={() => setShootModePopup(false)} className='w-full mx-auto h-[54px] text-[16px] leading-[24px] font-bold text-center bg-white flex items-center justify-center text-[#ADB2B9] rounded-md'>{t("shootingModePopupCancel")}</button>
              </div>
            </div>

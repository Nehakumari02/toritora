...
function Page() {
  ...
  return (
      <div className='absolute bg-white h-full w-full flex flex-col gap-8 items-center justify-center'>
        ...
        <span className='text-center font-semibold text-[13px] text-[#999999]'>Please try again later</span>
        <span className='px-4 text-center font-semibold text-[18px] leading-[27px] text-[#111111]'>Your payment was not successful</span>

        <div className='flex flex-col items-center justify-center space-y-2'>
          <span className='px-4 text-center font-normal text-[12px] text-[#1C1C1C]'>Your payment was not successful, kindly try again</span>

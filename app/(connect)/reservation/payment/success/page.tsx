...
function SuccessPage() {
  ...
  return (
      <div className='absolute bg-white h-full w-full flex flex-col gap-8 items-center justify-center'>
        ...
        <>
        <span className='text-center font-semibold text-[13px] text-[#999999]'>Congratulations!!!</span>
        ...
        <div className='flex flex-col items-center justify-center space-y-2'>
          {!loading &&<span className='px-4 text-center font-semibold text-[14px] text-[#111111]'>Amount recieved - {amount} JPY</span>}
          <span className='px-4 text-center font-normal text-[12px] text-[#1C1C1C]'>Transaction id for your reference</span>

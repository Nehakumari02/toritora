  ...
  return (
    <div className='flex flex-col h-full w-[100%] '>
      <header className="sticky z-10 top-0 w-full h-[72px] flex items-center justify-center bg-white shadow-lg">
        ...
        <span className="text-[16px] leading-[24px] text-center font-semibold">{t("search")}</span>
      </header>
      ...
      <div className='overflow-y-scroll w-full flex-1 no-scrollbar my-4'>
            ...
            <DrawerContent>
              ...
              <div className='space-y-8 mx-2 md:max-w-[800px] md:w-full md:mx-auto'>
                ...
                <div className='space-y-6'>
                  <span className='font-semibold text-[16px] leading-[24px]'>{t("searchFilters")} </span>
                  <hr />
                  ...
                  <div className='space-y-2'>
                    <span className='font-medium text-[14px] leading-[21px]'>{t("date")}</span>
                  ...
                  <div>
                    <span className='font-medium text-[14px] leading-[21px]'>{t("genres")}</span>
                  ...
                  <div className='space-y-2'>
                    <span className='font-medium text-[14px] leading-[21px]'>{t("modellingExperience")}</span>
                  ...
                  <div className='flex items-center justify-between flex-wrap'>
                    <button onClick={handleShowResults} className='w-[75%] mx-auto h-[54px] text-[16px] leading-[24px] font-bold text-center bg-secondary flex items-center justify-center text-white rounded-md'>{t("results")}</button>
                    <button onClick={clearFilters} className='w-[20%] mx-auto h-[54px] text-[16px] leading-[24px] font-bold text-center bg-white flex items-center justify-center text-[#ADB2B9] rounded-md'>{t("clear")}</button>
                  </div>
                </div>
              </div>
        ...
        <div className='max-w-[800px] mx-auto px-[4px] md:px-[10px] space-y-2 my-[24px]'>
          <div className='flex items-center justify-between'>
            <span className='text-[16px] font-medium leading-[24px]'>{t("searchResults")}</span>
          </div>
          ...
          {!loading && !searchResult.length && <span className='text-sm font-semibold text-[#999999]'>{t("noResult")}</span>}
        </div>
      </div>
    </div>
  );

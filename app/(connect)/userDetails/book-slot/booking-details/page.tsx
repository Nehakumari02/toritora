  ...
  return (
    <div className='flex flex-col h-full overflow-scroll no-scrollbar'>
      <header className="fixed top-0 w-full h-[72px] flex items-center justify-center bg-white shadow-lg">
        ...
        <span className="text-[16px] leading-[24px] text-center font-semibold">Fill Booking details</span>
      </header>
      ...
      <div className='bg-[#FFBF691A] border-[1px] border-[#99999914] min-h-[50px] py-2 font-medium text-[12px] leading-[18px] text-[#777777] flex items-center justify-start md:justify-center px-4'>
        Input is optional, but please provide as much information as possible.
      </div>
      ...
      <div className='no-scrollbar my-8'>
          ...
          <div className='px-4 space-y-8 max-w-[800px] mx-auto'>
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Shooting Place <span className='text-[#FF0000]'>*</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "shootingPlace" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
            ...
            <div className='space-y-2'>
              <label className='block text-sm'>Shooting Location <span className="text-red-500 hidden">*</span></label>
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Meeting Point </span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "meetingPoint"? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Shooting Concept </span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "shootingConcept" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Clothing Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "clothingType" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Shoes Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "shoesType" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Items Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "itemsType" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Make Up Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "makeUpType" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
      ...
      <div className='min-h-[50px] py-2 font-medium text-[12px] leading-[18px] text-[#999999] flex items-center justify-start md:justify-center px-4'>
        <div className="flex items-center gap-2">
          ...
          <label htmlFor="checked-checkbox" className="text-[14px] leading-[21px] font-medium text-[#000000]">
            Put same contents for rainy occasions
          </label>
        </div>
      </div>
      ...
      <div className='no-scrollbar my-8'>
          ...
          <div className='px-4 space-y-8 max-w-[800px] mx-auto'>
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Rainy Shooting Place <span className='text-[#FF0000]'>*</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "shootingPlaceRainy" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
                {/* <UserIcon fill={isFocused === "shootingPlace" ?"#FF9F1C":"#2EC4B6"}/> */}
                <input
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Rainy Meeting Point </span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "meetingPointRainy"? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
                {/* <UserIcon fill={isFocused === "meetingPoint" ?"#FF9F1C":"#2EC4B6"}/> */}
                <input
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Rainy Shooting Concept </span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "shootingConceptRainy" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
                {/* <CalendarIcon fill={isFocused === "shootingConcept" ?"#FF9F1C":"#2EC4B6"}/> */}
                <input
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Rainy Clothing Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "clothingTypeRainy" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
                {/* <CalendarIcon fill={isFocused === "clothingType" ?"#FF9F1C":"#2EC4B6"}/> */}
                <input
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Rainy Shoes Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "shoesTypeRainy" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
                {/* <CalendarIcon fill={isFocused === "shoesType" ?"#FF9F1C":"#2EC4B6"}/> */}
                <input
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Rainy Items Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "itemsTypeRainy" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
                {/* <CalendarIcon fill={isFocused === "itemsType" ?"#FF9F1C":"#2EC4B6"}/> */}
                <input
            ...
            <div className='space-y-2'>
              <span className='font-medium text-[14px] leading-[21px] text-[#333333]'>Rainy Make Up Type <span className='font-normal text-[10px] leading-[15px] text-[#777777]'>(optional)</span></span>
              <div
                className={`h-[48px] flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-300 ${
                  isFocused === "makeUpTypeRainy" ? 'border-[#FF9F1C]' : 'border-[#999999]'
                }`}
              >
                {/* <CalendarIcon fill={isFocused === "makeUpType" ?"#FF9F1C":"#2EC4B6"}/> */}
                <input
      ...
      <div className='px-4 py-4 flex items-center justify-center'>
        <button onClick={handleSlotBooking} disabled={savingStatus} className='w-[calc(min(100%,800px))] h-[54px] text-[16px] leading-[24px] font-bold text-center bg-secondary flex items-center justify-center text-white rounded-md'>{savingStatus?<Loader2 className='animate-spin'/>:"Send Request"}</button>
      </div>

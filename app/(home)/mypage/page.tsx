  ...
  return (
    <div className='flex flex-col h-full'>
      <header className="sticky top-0 w-full h-[72px] flex items-center justify-center bg-white shadow-[0_4px_20px_rgba(0,0,0,0.15)]">
        <span className="text-[16px] leading-[24px] text-center font-semibold">{t("myPage")}</span>
      </header>
...
const fileAddIcon = <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.1739 23H4.67382C3.15503 23 1.92382 21.7688 1.92383 20.25L1.92393 3.74999C1.92394 2.23121 3.15516 1 4.67394 1H17.0493C18.5681 1 19.7993 2.23122 19.7993 3.75001V11.3125M18.188 22.5282V18.6391M18.188 18.6391V14.75M18.188 18.6391L14.2989 18.6391M18.188 18.6391L22.0771 18.6391M6.73677 6.50002H14.9868M6.73677 10.625H14.9868M6.73677 14.75H10.8618" stroke="#2EC4B6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

const graphIcon = <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M15.5619 23V2.97122C15.5619 1.88255 14.6794 1 13.5907 1H10.2003C9.11162 1 8.22908 1.88255 8.22908 2.97122V23M15.5619 23L15.5601 11.2699C15.5599 10.1812 16.4425 9.29841 17.5313 9.29841H20.9214C22.01 9.29841 22.8926 10.181 22.8926 11.2696V21.0288C22.8926 22.1175 22.01 23 20.9214 23H15.5619ZM15.5619 23H8.22908M8.22908 23V17.7089C8.22908 16.6202 7.34653 15.7377 6.25785 15.7377H3.07683C1.98815 15.7377 1.10561 16.6202 1.10561 17.7089V21.0288C1.10561 22.1175 1.98815 23 3.07683 23H8.22908Z" stroke="#2EC4B6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

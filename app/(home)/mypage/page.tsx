    ...
    const fetchUser = async () => {
      try {
        ...
        if (res.status === 200) {
          ...
          setUserId(data.user?.userId ?? 'Anonymous');
            ...
            <div className='flex-1 flex flex-wrap gap-2 items-center justify-between'>
              <div className='flex flex-col items-start justify-center gap-1'>
                {loading ?
                  ...
                  <>
                    <span className='font-semibold text-[16px] leading-[24px] text-[#111111]'>{userName}</span>
                    <span className='font-medium text-[10px] leading-[15px] text-[#999999]'>{userId}</span>
                  </>
                }
              </div>
...
const cameraSmallIcon = <svg width="20" height="20" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M7.97271 4.61644V5.61644C8.32838 5.61644 8.65728 5.42753 8.83649 5.12031L7.97271 4.61644ZM10.0823 1V0C9.72663 0 9.39773 0.188911 9.21852 0.496129L10.0823 1ZM17.9179 1L18.7817 0.496129C18.6025 0.188911 18.2736 0 17.9179 0V1ZM20.0275 4.61644L19.1637 5.12031C19.3429 5.42753 19.6718 5.61644 20.0275 5.61644V4.61644ZM2.94531 19.9863V7.63014H0.945312V19.9863H2.94531ZM4.95901 5.61644H7.97271V3.61644H4.95901V5.61644ZM8.83649 5.12031L10.9461 1.50387L9.21852 0.496129L7.10893 4.11257L8.83649 5.12031ZM10.0823 2H17.9179V0H10.0823V2ZM17.0541 1.50387L19.1637 5.12031L20.8913 4.11257L18.7817 0.496129L17.0541 1.50387ZM20.0275 5.61644H23.0412V3.61644H20.0275V5.61644ZM25.0549 7.63014V19.9863H27.0549V7.63014H25.0549ZM25.0549 19.9863C25.0549 21.0984 24.1533 22 23.0412 22V24C25.2579 24 27.0549 22.203 27.0549 19.9863H25.0549ZM23.0412 5.61644C24.1533 5.61644 25.0549 6.518 25.0549 7.63014H27.0549C27.0549 5.41343 25.2579 3.61644 23.0412 3.61644V5.61644ZM2.94531 7.63014C2.94531 6.518 3.84688 5.61644 4.95901 5.61644V3.61644C2.74231 3.61644 0.945312 5.41343 0.945312 7.63014H2.94531ZM4.95901 22C3.84688 22 2.94531 21.0984 2.94531 19.9863H0.945312C0.945312 22.203 2.74231 24 4.95901 24V22ZM17.5207 13.0548C17.5207 14.9991 15.9445 16.5753 14.0001 16.5753V18.5753C17.049 18.5753 19.5207 16.1037 19.5207 13.0548H17.5207ZM14.0001 16.5753C12.0558 16.5753 10.4796 14.9991 10.4796 13.0548H8.47956C8.47956 16.1037 10.9512 18.5753 14.0001 18.5753V16.5753ZM10.4796 13.0548C10.4796 11.1104 12.0558 9.53425 14.0001 9.53425V7.53425C10.9512 7.53425 8.47956 10.0059 8.47956 13.0548H10.4796ZM14.0001 9.53425C15.9445 9.53425 17.5207 11.1104 17.5207 13.0548H19.5207C19.5207 10.0059 17.049 7.53425 14.0001 7.53425V9.53425ZM23.0412 22H4.95901V24H23.0412V22Z" fill="#2EC4B6" />
</svg>

const shareIcon = <svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M16.5 14.7402C15.8033 14.7402 15.18 15.0152 14.7033 15.446L8.1675 11.6418C8.21333 11.431 8.25 11.2202 8.25 11.0002C8.25 10.7802 8.21333 10.5693 8.1675 10.3585L14.63 6.591C15.125 7.04933 15.7758 7.3335 16.5 7.3335C18.0217 7.3335 19.25 6.10516 19.25 4.5835C19.25 3.06183 18.0217 1.8335 16.5 1.8335C14.9783 1.8335 13.75 3.06183 13.75 4.5835C13.75 4.8035 13.7867 5.01433 13.8325 5.22516L7.37 8.99266C6.875 8.53433 6.22417 8.25016 5.5 8.25016C3.97833 8.25016 2.75 9.4785 2.75 11.0002C2.75 12.5218 3.97833 13.7502 5.5 13.7502C6.22417 13.7502 6.875 13.466 7.37 13.0077L13.8967 16.821C13.8508 17.0135 13.8233 17.2152 13.8233 17.4168C13.8233 18.8927 15.0242 20.0935 16.5 20.0935C17.9758 20.0935 19.1767 18.8927 19.1767 17.4168C19.1767 15.941 17.9758 14.7402 16.5 14.7402Z" fill="#2EC4B6" />
</svg>

const termsOfUseIcon = <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M18 22C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V4C20 3.46957 19.7893 2.96086 19.4142 2.58579C19.0391 2.21071 18.5304 2 18 2H12V9L9.5 7.5L7 9V2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18Z" fill="#2EC4B6" />
</svg>

const privacyIcon = <svg width="20" height="20" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">

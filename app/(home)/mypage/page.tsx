...
function MyPage() {
  ...
  const navigationList = [
    {
      name: t("shootingRequestList"),
      link: "/shootingRequestList",
      icon: cameraIcon
    },
    {
      name: t("toritaiToraretai"),
    ...
    {
      name: t("toritoraCollege"),
      link: "https://toritora.co.jp/",
      icon: fileIcon
    }
  ]
...
const settingsIcon = <svg width="20" height="20" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const questionIcon = <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const feedbackIcon = <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">

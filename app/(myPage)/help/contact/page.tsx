    ...
    <div className=''>
      ...
      <div className='mx-8 py-8 space-y-8 md:max-w-[800px] md:mx-auto'>
        <div className='space-y-4' >
          <span className='font-semibold text-[18px] leading-[24px] text-[#111111]'>{t("help2")}</span>
          <div className='pl-4 space-y-2'>
                <div className='' >
                  <span className='font-semibold text-[16px] leading-[20px] text-[#333333]'>{t("help2_description")}</span>
                </div>
          </div>
        </div>
      </div>

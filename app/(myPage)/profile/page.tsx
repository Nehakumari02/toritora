  ...
  return (
    <div className='flex flex-col h-full'>
      <header className="sticky top-0 w-full h-[72px] flex items-center justify-center bg-white shadow-lg">
        ...
        <span className="text-[16px] leading-[24px] text-center font-semibold">{t("myProfile")}</span>
      ...
      <div className='bg-[#f8fcfd] p-4 py-6 overflow-y-scroll flex-1 no-scrollbar'>
        <div className='min-h-[120px] max-w-[800px] mx-auto bg-white rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.15)] flex items-center justify-between gap-4 px-4'>
          ...
          <div className='flex-1 flex items-center justify-between flex-wrap space-y-2'>
            <div className='flex flex-col items-start justify-center gap-1'>
              ...
              <Link className='font-medium text-[10px] leading-[15px] text-[#E10101] flex items-center justify-center ' href={'/points-history'}>{t("pointHistory")} {rightArrowIcon}</Link>
            </div>
        ...
        <div className='flex flex-row items-center justify-center flex-wrap gap-4 py-6'>
          <div className='flex flex-col items-center justify-center gap-2'>
            <div className='h-[98px] w-[108px] rounded-md flex flex-col items-center justify-center gap-4 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.15)]'>
              {bronzeBadgeIcon}
              <span className='font-semibold text-[14px] leading-[21px] text-[#111111]'>{t("bronze")}</span>
            </div>
            <span className='font-semibold text-[12px] leading-[18px] text-[#999999]'>{t("100")}</span>
          </div>
          <div className='flex flex-col items-center justify-center gap-2'>
            <div className='h-[98px] w-[108px] rounded-md flex flex-col items-center justify-center gap-4 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.15)]'>
              {yellowBadgeIcon}
              <span className='font-semibold text-[14px] leading-[21px] text-[#111111]'>{t("gold")}</span>
            </div>
            <span className='font-semibold text-[12px] leading-[18px] text-[#999999]'> &gt;{t("800")}</span>
          </div>
          <div className='flex flex-col items-center justify-center gap-2'>
            <div className='h-[98px] w-[108px] rounded-md flex flex-col items-center justify-center gap-4 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.15)]'>
              {diamongBadgeIcon}
              <span className='font-semibold text-[14px] leading-[21px] text-[#111111]'>{t("platinum")}</span>
            </div>
            <span className='font-semibold text-[12px] leading-[18px] text-[#999999]'>&gt;{t("1500")}</span>
          </div>
        </div>

        <div className='max-w-[800px] mx-auto'>
          <span className='text-[14px] leading-[20px] font-semibold text-[#111111]'>{t("ProfessionalInformation")}</span>
        </div>
        ...
        <div className='max-w-[800px] mx-auto mt-4 bg-white p-4 space-y-4 rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.15)]'>
          ...
          <div className='flex flex-row gap-4 flex-wrap items-center justify-between'>
            <span className='flex-1 min-w-[150px] font-medium text-[14px] leading-[25px] text-[#111111]'>{t("genres")}</span>
            {loading ?
              <>
                <div className='h-4 min-w-[180px] flex-1 bg-gray-200 animate-pulse rounded-md'></div>
              </> :

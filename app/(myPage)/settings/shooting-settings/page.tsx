...
function ShootingSettings() {
  const router = useRouter();
  const t = useTranslations("MyPage.settings.shootingSettingsPage")
  ...
  return (
    <div className=''>
      <header className="sticky top-0 w-full h-[72px] flex items-center justify-center bg-white shadow-lg">
        ...
        <span className="text-[16px] leading-[24px] text-center font-semibold">{t("shootingSettings")}</span>
      </header>
...
export default ShootingSettings
                    ...
                    >
                      ...
                      <div className={`w-full p-4 border-t space-y-4 border-gray-200 ${isExpanded ? "" : "hidden"}`}>
                        <div className=''>
                          ...
                          <p className='text-[12px] text-[#777777] font-normal'><span className='text-[14px] text-[#111111] font-medium'>{t("shootingPlace")}:</span> {request?.shootingLocation || "N/A"}</p>
                        ...
                        <div className=''>
                          ...
                          <p className='text-[12px] text-[#777777] font-normal'><span className='text-[14px] text-[#111111] font-medium'>{t("shootingPlace")}:</span> {request?.shootingLocationRainy || "N/A"}</p>
